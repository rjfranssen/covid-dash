...
# Save off these data in case the API quits but we want to still use this app.
#save.image(file = "data/covid_app_data_run_11MAR2021.RData")
#load(file = "data/covid_app_data_run_11MAR2021.RData")
